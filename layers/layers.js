...
var lyr_PostEECOClimateType_1 = new ol.layer.Vector({
    ...
    <img src="styles/legend/PostEECOClimateType_1_1.png" /> Temperate (CT)<br />\
...
var lyr_EECOClimateType_4 = new ol.layer.Vector({
    ...
    <img src="styles/legend/EECOClimateType_4_1.png" /> Temperate (CT)<br />\
...
var lyr_PostPETMClimateType_7 = new ol.layer.Vector({
    ...
    <img src="styles/legend/PostPETMClimateType_7_1.png" /> Temperate (CT)<br />\
...
var lyr_PETMClimateType_10 = new ol.layer.Vector({
    ...
    <img src="styles/legend/PETMClimateType_10_1.png" /> Temperate (CT)<br />\
...
var lyr_LPClimateType_13 = new ol.layer.Vector({
    ...
    <img src="styles/legend/LPClimateType_13_1.png" /> Temperate (CT)<br />\
...
var lyr_EPClimateType_16 = new ol.layer.Vector({
    ...
    <img src="styles/legend/EPClimateType_16_1.png" /> Temperate (CT)<br />\
...
lyr_PostEECOSites_2.set('fieldAliases', {'Location': 'Location', 'Temperatur': 'Mean annual temperature (°C)', 'Temperat_1': 'Temperature seasonality', 'Proxy': 'Temperature proxy', 'Precipitat': 'Mean annual precipitation (mm/yr)', 'Precipit_1': 'Precipitation seasonality', 'Proxy_1': 'Precipitation proxy', 'Climate Ty': 'Climate type', 'Uncertaint': 'Uncertainty', 'Latitude': 'Modern latitude', 'Longitude': 'Modern longitude', 'Variabilit': 'Precipitation intermittency', 'Paleolat': 'Paleolatitude', 'Paleolong': 'Paleolongitude', 'Temperat_2': 'Temperature source', 'Precipit_2': 'Precipitation source', });
...
lyr_PostPETMClimateType_7.set('fieldAliases', {'Location': 'Location', 'Temperatur': 'Temperatur', 'Temperat_1': 'Temperat_1', 'Proxies': 'Proxies', 'Precipitat': 'Precipitat', 'Precipit_1': 'Precipit_1', 'Proxies_1': 'Proxies_1', 'Climate_Ty': 'Climate_Ty', 'Uncertaint': 'Uncertaint', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Paleolatit': 'Paleolatit', 'Paleolongi': 'Paleolongi', 'Temperat_2': 'Temperat_2', 'Precipit_2': 'Precipit_2', 'BUFF_DIST': 'BUFF_DIST', 'ORIG_FID': 'ORIG_FID', });
lyr_PostPETMSites_8.set('fieldAliases', {'Location': 'Location', 'Temperatur': 'Mean annual temperature (°C)', 'Temperat_1': 'Temperature seasonality', 'Proxies': 'Proxies', 'Precipitat': 'Mean annual precipitation (mm/yr)', 'Precipit_1': 'Precipitation seasonality', 'Proxies_1': 'Proxies_1', 'Climate Ty': 'Climate type', 'Uncertaint': 'Uncertainty', 'Latitude': 'Modern latitude', 'Longitude': 'Modern longitude', 'Paleolatit': 'Paleolatit', 'Paleolongi': 'Paleolongi', 'Temperat_2': 'Temperature source', 'Precipit_2': 'Precipitation source', });
...
lyr_PETMClimateType_10.set('fieldAliases', {'Location': 'Location', 'Temperatur': 'Temperatur', 'Temperat_1': 'Temperat_1', 'Proxy': 'Proxy', 'Precipitat': 'Precipitat', 'Precipit_1': 'Precipit_1', 'Proxy_1': 'Proxy_1', 'Climate_Ty': 'Climate_Ty', 'Uncertaint': 'Uncertaint', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Paleolat': 'Paleolat', 'Paleolong': 'Paleolong', 'Variabilit': 'Variabilit', 'Temperat_2': 'Temperat_2', 'Precipit_2': 'Precipit_2', 'BUFF_DIST': 'BUFF_DIST', 'ORIG_FID': 'ORIG_FID', });
lyr_PETMSites_11.set('fieldAliases', {'NAME': 'NAME', 'Location': 'Location', 'Temperatur': 'Mean annual temperature (°C)', 'Temperat_1': 'Temperature seasonality', 'Proxy': 'Temperature proxy', 'Precipitat': 'Mean annual precipitation (mm/yr)', 'Precipit_1': 'Precipitation seasonality', 'Proxy_1': 'Precipitation proxy', 'Climate Ty': 'Climate type', 'Uncertaint': 'Uncertainty', 'Latitude': 'Modern latitude', 'Longitude': 'Modern longitude', 'Paleolat': 'Paleolatitude', 'Paleolong': 'Paleolongitude', 'Variabilit': 'Precipitation intermittency', 'Temperat_2': 'Temperature source', 'Precipit_2': 'Precipitation source', });
...
lyr_PostEECOSites_2.set('fieldImages', {'Location': 'TextEdit', 'Temperatur': 'TextEdit', 'Temperat_1': 'TextEdit', 'Proxy': 'TextEdit', 'Precipitat': 'TextEdit', 'Precipit_1': 'TextEdit', 'Proxy_1': 'TextEdit', 'Climate Ty': 'TextEdit', 'Uncertaint': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Variabilit': 'TextEdit', 'Paleolat': 'TextEdit', 'Paleolong': 'TextEdit', 'Temperat_2': 'TextEdit', 'Precipit_2': 'TextEdit', });
...
lyr_EECOSites_5.set('fieldImages', {'Location': 'TextEdit', 'Temperatur': 'TextEdit', 'Temperat_1': 'TextEdit', 'Proxy': 'TextEdit', 'Precipitat': 'TextEdit', 'Precipit_1': 'TextEdit', 'Proxy_1': 'TextEdit', 'Climate Ty': 'TextEdit', 'Uncertaint': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Variabilit': 'TextEdit', 'Paleolat': 'TextEdit', 'Paleolong': 'TextEdit', 'Temperat_2': 'TextEdit', 'Precipit_2': 'TextEdit', });
...
lyr_PostPETMClimateType_7.set('fieldImages', {'Location': 'Hidden', 'Temperatur': 'Hidden', 'Temperat_1': 'Hidden', 'Proxies': 'TextEdit', 'Precipitat': 'Hidden', 'Precipit_1': 'Hidden', 'Proxies_1': 'TextEdit', 'Climate_Ty': 'TextEdit', 'Uncertaint': 'Hidden', 'Latitude': 'Hidden', 'Longitude': 'Hidden', 'Paleolatit': 'TextEdit', 'Paleolongi': 'TextEdit', 'Temperat_2': 'Hidden', 'Precipit_2': 'Hidden', 'BUFF_DIST': 'Hidden', 'ORIG_FID': 'Hidden', });
lyr_PostPETMSites_8.set('fieldImages', {'Location': 'TextEdit', 'Temperatur': 'TextEdit', 'Temperat_1': 'TextEdit', 'Proxies': 'TextEdit', 'Precipitat': 'TextEdit', 'Precipit_1': 'TextEdit', 'Proxies_1': 'TextEdit', 'Climate Ty': 'TextEdit', 'Uncertaint': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Paleolatit': 'TextEdit', 'Paleolongi': 'TextEdit', 'Temperat_2': 'TextEdit', 'Precipit_2': 'TextEdit', });
...
lyr_PETMClimateType_10.set('fieldImages', {'Location': 'Hidden', 'Temperatur': 'Hidden', 'Temperat_1': 'Hidden', 'Proxy': 'Hidden', 'Precipitat': 'Hidden', 'Precipit_1': 'Hidden', 'Proxy_1': 'Hidden', 'Climate_Ty': 'TextEdit', 'Uncertaint': 'Hidden', 'Latitude': 'Hidden', 'Longitude': 'Hidden', 'Paleolat': 'Hidden', 'Paleolong': 'Hidden', 'Variabilit': 'Hidden', 'Temperat_2': 'Hidden', 'Precipit_2': 'Hidden', 'BUFF_DIST': 'Hidden', 'ORIG_FID': 'Hidden', });
lyr_PETMSites_11.set('fieldImages', {'NAME': 'Hidden', 'Location': 'TextEdit', 'Temperatur': 'TextEdit', 'Temperat_1': 'TextEdit', 'Proxy': 'TextEdit', 'Precipitat': 'TextEdit', 'Precipit_1': 'TextEdit', 'Proxy_1': 'TextEdit', 'Climate Ty': 'TextEdit', 'Uncertaint': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Paleolat': 'TextEdit', 'Paleolong': 'TextEdit', 'Variabilit': 'TextEdit', 'Temperat_2': 'TextEdit', 'Precipit_2': 'TextEdit', });
...
lyr_LPSites_14.set('fieldImages', {'Location': 'TextEdit', 'Temperatur': 'TextEdit', 'Temperat_1': 'TextEdit', 'Proxy': 'TextEdit', 'Precipitat': 'TextEdit', 'Precipit_1': 'TextEdit', 'Proxy_1': 'TextEdit', 'Climate Ty': 'TextEdit', 'Uncertaint': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Variabilit': 'TextEdit', 'Paleolat': 'TextEdit', 'Paleolong': 'TextEdit', 'Temperat_2': 'TextEdit', 'Precipit_2': 'TextEdit', });
...
lyr_EPSites_17.set('fieldImages', {'Location': 'TextEdit', 'Temperatur': 'TextEdit', 'Temperat_1': 'TextEdit', 'Proxy': 'TextEdit', 'Precipitat': 'TextEdit', 'Precipit_1': 'TextEdit', 'Proxy_1': 'TextEdit', 'Climate Ty': 'TextEdit', 'Uncertaint': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Variabilit': 'TextEdit', 'Paleolat': 'TextEdit', 'Paleolong': 'TextEdit', 'Temperat_2': 'TextEdit', 'Precipit_2': 'TextEdit', });
...
lyr_PostEECOClimateType_1.set('fieldLabels', {'Climate_Ty': 'no label', });
lyr_PostEECOSites_2.set('fieldLabels', {'Location': 'header label', 'Temperatur': 'header label', 'Temperat_1': 'header label', 'Proxy': 'header label', 'Precipitat': 'header label', 'Precipit_1': 'header label', 'Proxy_1': 'header label', 'Climate Ty': 'header label', 'Uncertaint': 'header label', 'Latitude': 'header label', 'Longitude': 'header label', 'Variabilit': 'header label', 'Paleolat': 'header label', 'Paleolong': 'header label', 'Temperat_2': 'header label', 'Precipit_2': 'header label', });
lyr_EECOBaseMap_3.set('fieldLabels', {});
lyr_EECOClimateType_4.set('fieldLabels', {'Climate_Ty': 'no label', });
lyr_EECOSites_5.set('fieldLabels', {'Location': 'header label', 'Temperatur': 'header label', 'Temperat_1': 'header label', 'Proxy': 'header label', 'Precipitat': 'header label', 'Precipit_1': 'header label', 'Proxy_1': 'header label', 'Climate Ty': 'header label', 'Uncertaint': 'header label', 'Latitude': 'header label', 'Longitude': 'header label', 'Variabilit': 'header label', 'Paleolat': 'header label', 'Paleolong': 'header label', 'Temperat_2': 'header label', 'Precipit_2': 'header label', });
lyr_PostPETMBaseMap_6.set('fieldLabels', {'FILE2': 'no label', });
lyr_PostPETMClimateType_7.set('fieldLabels', {'Proxies': 'no label', 'Proxies_1': 'no label', 'Climate_Ty': 'no label', 'Paleolatit': 'no label', 'Paleolongi': 'no label', });
lyr_PostPETMSites_8.set('fieldLabels', {'Location': 'header label', 'Temperatur': 'header label', 'Temperat_1': 'header label', 'Proxies': 'header label', 'Precipitat': 'header label', 'Precipit_1': 'header label', 'Proxies_1': 'header label', 'Climate Ty': 'header label', 'Uncertaint': 'header label', 'Latitude': 'header label', 'Longitude': 'header label', 'Paleolatit': 'header label', 'Paleolongi': 'header label', 'Temperat_2': 'header label', 'Precipit_2': 'header label', });
...
lyr_PETMClimateType_10.set('fieldLabels', {'Climate_Ty': 'no label', });
lyr_PETMSites_11.set('fieldLabels', {'Location': 'header label', 'Temperatur': 'header label', 'Temperat_1': 'header label', 'Proxy': 'header label', 'Precipitat': 'header label', 'Precipit_1': 'header label', 'Proxy_1': 'header label', 'Climate Ty': 'header label', 'Uncertaint': 'header label', 'Latitude': 'header label', 'Longitude': 'header label', 'Paleolat': 'header label', 'Paleolong': 'header label', 'Variabilit': 'header label', 'Temperat_2': 'header label', 'Precipit_2': 'header label', });
lyr_LPBaseMap_12.set('fieldLabels', {'FILE2': 'no label', });
lyr_LPClimateType_13.set('fieldLabels', {'Climate_Ty': 'no label', });
lyr_LPSites_14.set('fieldLabels', {'Location': 'header label', 'Temperatur': 'header label', 'Temperat_1': 'header label', 'Proxy': 'header label', 'Precipitat': 'header label', 'Precipit_1': 'header label', 'Proxy_1': 'header label', 'Climate Ty': 'header label', 'Uncertaint': 'header label', 'Latitude': 'header label', 'Longitude': 'header label', 'Variabilit': 'header label', 'Paleolat': 'header label', 'Paleolong': 'header label', 'Temperat_2': 'header label', 'Precipit_2': 'header label', });
lyr_EPBaseMap_15.set('fieldLabels', {'FILE2': 'no label', });
lyr_EPClimateType_16.set('fieldLabels', {'Climate_Ty': 'no label', });
lyr_EPSites_17.set('fieldLabels', {'Location': 'header label', 'Temperatur': 'header label', 'Temperat_1': 'header label', 'Proxy': 'header label', 'Precipitat': 'header label', 'Precipit_1': 'header label', 'Proxy_1': 'header label', 'Climate Ty': 'header label', 'Uncertaint': 'header label', 'Latitude': 'header label', 'Longitude': 'header label', 'Variabilit': 'header label', 'Paleolat': 'header label', 'Paleolong': 'header label', 'Temperat_2': 'header label', 'Precipit_2': 'header label', });
