...
var lyr_Modernraster_0 = new ol.layer.Image({
                            opacity: 1,
                            title: "Modern raster",
                            
                            
                            source: new ol.source.ImageStatic({
                               url: "./layers/Modernraster_0.png",
    attributions: ' ',
...
var format_PostEECOBaseMap_1 = new ol.format.GeoJSON();
var features_PostEECOBaseMap_1 = format_PostEECOBaseMap_1.readFeatures(json_PostEECOBaseMap_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_PostEECOBaseMap_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostEECOBaseMap_1.addFeatures(features_PostEECOBaseMap_1);
var lyr_PostEECOBaseMap_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_PostEECOBaseMap_1, 
                style: style_PostEECOBaseMap_1,
                interactive: false,
                title: '<img src="styles/legend/PostEECOBaseMap_1.png" /> Post-EECO Base Map'
            });
...
var lyr_PostEECOClimateType_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/PostEECOClimateType_2_0.png" /> Af<br />\
    <img src="styles/legend/PostEECOClimateType_2_1.png" /> Am<br />\
    <img src="styles/legend/PostEECOClimateType_2_2.png" /> Aw<br />\
    <img src="styles/legend/PostEECOClimateType_2_3.png" /> B<br />\
    <img src="styles/legend/PostEECOClimateType_2_4.png" /> Bs<br />\
    <img src="styles/legend/PostEECOClimateType_2_5.png" /> Bsh<br />\
    <img src="styles/legend/PostEECOClimateType_2_6.png" /> Bsk<br />\
    <img src="styles/legend/PostEECOClimateType_2_7.png" /> Bw<br />\
    <img src="styles/legend/PostEECOClimateType_2_8.png" /> Bwh<br />\
    <img src="styles/legend/PostEECOClimateType_2_9.png" /> Cf<br />\
    <img src="styles/legend/PostEECOClimateType_2_10.png" /> Cfa<br />\
    <img src="styles/legend/PostEECOClimateType_2_11.png" /> Cfb<br />\
    <img src="styles/legend/PostEECOClimateType_2_12.png" /> Cfr<br />\
    <img src="styles/legend/PostEECOClimateType_2_13.png" /> Cm<br />\
    <img src="styles/legend/PostEECOClimateType_2_14.png" /> D<br />\
    <img src="styles/legend/PostEECOClimateType_2_15.png" /> E<br />'
        });
...
lyr_Modernraster_0.setVisible(true);lyr_PostEECOBaseMap_1.setVisible(true);lyr_PostEECOClimateType_2.setVisible(true);lyr_PostEECOSites_3.setVisible(true);lyr_EECOBaseMap_4.setVisible(true);lyr_EECOSites_5.setVisible(true);lyr_PostPETMBaseMap_6.setVisible(true);lyr_PostPETMClimateType_7.setVisible(true);lyr_PostPETMSites_8.setVisible(true);lyr_PETMBaseMap_9.setVisible(true);lyr_PETMClimateType_10.setVisible(true);lyr_PETMSites_11.setVisible(true);lyr_LPBaseMap_12.setVisible(true);lyr_LPClimateType_13.setVisible(true);lyr_LPSites_14.setVisible(true);lyr_EPBaseMap_15.setVisible(true);lyr_EPClimateType_16.setVisible(true);lyr_EPSites_17.setVisible(true);
var layersList = [lyr_Modernraster_0,lyr_PostEECOBaseMap_1,lyr_PostEECOClimateType_2,lyr_PostEECOSites_3,lyr_EECOBaseMap_4,lyr_EECOSites_5,lyr_PostPETMBaseMap_6,lyr_PostPETMClimateType_7,lyr_PostPETMSites_8,lyr_PETMBaseMap_9,lyr_PETMClimateType_10,lyr_PETMSites_11,lyr_LPBaseMap_12,lyr_LPClimateType_13,lyr_LPSites_14,lyr_EPBaseMap_15,lyr_EPClimateType_16,lyr_EPSites_17];
lyr_PostEECOBaseMap_1.set('fieldAliases', {'ANCHOR': 'ANCHOR', 'TIME': 'TIME', 'FILE1': 'FILE1', 'RECONFILE1': 'RECONFILE1', 'RECONFILE2': 'RECONFILE2', 'RECONFILE3': 'RECONFILE3', 'PLATEID1': 'PLATEID1', 'TYPE': 'TYPE', 'FROMAGE': 'FROMAGE', 'TOAGE': 'TOAGE', 'NAME': 'NAME', 'PLATEID2': 'PLATEID2', 'GPGIM_TYPE': 'GPGIM_TYPE', 'L_PLATE': 'L_PLATE', 'R_PLATE': 'R_PLATE', 'SPREAD_ASY': 'SPREAD_ASY', });
...
lyr_LPSites_14.set('fieldAliases', {'Location': 'Location', 'Mean annua': 'Mean annual temperature (°C)', 'Temperatur': 'Temperature seasonality', 'Temperat_1': 'Temperature proxy', 'Mean ann_1': 'Mean annual precipitation (mm/yr)', 'Precipitat': 'Precipitation seasonality', 'Precipit_1': 'Precipitation proxy', 'Climate ty': 'Climate type', 'Uncertaint': 'Uncertainty', 'Modern lat': 'Modern latitude', 'Modern lon': 'Modern longitude', 'Precipit_2': 'Precipitation intermittency', 'Paleolatit': 'Paleolatitude', 'Paleolongi': 'Paleolongitude', 'Temperat_2': 'Temperature source', 'Precipit_3': 'Precipitation source', 'Geochronol': 'Geochronology', 'Notes': 'Notes', 'Perror': 'Precipitation uncertainty (1 sigma)', 'Terror': 'Temperature uncertainty (1 sigma)', });
...
lyr_PostEECOBaseMap_1.set('fieldImages', {'ANCHOR': 'Hidden', 'TIME': 'Hidden', 'FILE1': 'Hidden', 'RECONFILE1': 'Hidden', 'RECONFILE2': 'Hidden', 'RECONFILE3': 'Hidden', 'PLATEID1': 'Hidden', 'TYPE': 'Hidden', 'FROMAGE': 'Hidden', 'TOAGE': 'Hidden', 'NAME': 'Hidden', 'PLATEID2': 'Hidden', 'GPGIM_TYPE': 'Hidden', 'L_PLATE': 'Hidden', 'R_PLATE': 'Hidden', 'SPREAD_ASY': 'Hidden', });
lyr_PostEECOClimateType_2.set('fieldImages', {'Location': 'TextEdit', 'Mean annua': 'TextEdit', 'Temperatur': 'TextEdit', 'Temperat_1': 'TextEdit', 'Mean ann_1': 'TextEdit', 'Precipitat': 'TextEdit', 'Precipit_1': 'TextEdit', 'Climate ty': 'TextEdit', 'Uncertaint': 'TextEdit', 'Modern lat': 'TextEdit', 'Modern lon': 'TextEdit', 'Precipit_2': 'TextEdit', 'Paleolatit': 'TextEdit', 'Paleolongi': 'TextEdit', 'Temperat_2': 'TextEdit', 'Precipit_3': 'TextEdit', 'Geochronol': 'TextEdit', 'Notes': 'TextEdit', });
...
lyr_PostEECOBaseMap_1.set('fieldLabels', {});
lyr_PostEECOClimateType_2.set('fieldLabels', {'Location': 'no label', 'Mean annua': 'no label', 'Temperatur': 'no label', 'Temperat_1': 'no label', 'Mean ann_1': 'no label', 'Precipitat': 'no label', 'Precipit_1': 'no label', 'Climate ty': 'no label', 'Uncertaint': 'no label', 'Modern lat': 'no label', 'Modern lon': 'no label', 'Precipit_2': 'no label', 'Paleolatit': 'no label', 'Paleolongi': 'no label', 'Temperat_2': 'no label', 'Precipit_3': 'no label', 'Geochronol': 'no label', 'Notes': 'no label', });
