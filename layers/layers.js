...
lyr_EECOClimateType_4.set('fieldLabels', {'Mean annua': 'no label', 'Mean ann_1': 'no label', 'Climate Ty': 'no label', 'Modern lat': 'no label', 'Modern lon': 'no label', 'Paleolatit': 'no label', 'Paleolongi': 'no label', 'Precipit_3': 'no label', 'Geochronol': 'no label', });
...
lyr_PETMClimateType_10.set('fieldLabels', {'Mean annua': 'no label', 'Mean ann_1': 'no label', 'Climate Ty': 'no label', 'Modern lat': 'no label', 'Modern lon': 'no label', 'Paleolatit': 'no label', 'Paleolongi': 'no label', 'Precipit_3': 'no label', 'Geochronol': 'no label', 'Notes': 'no label', });
...
lyr_LPClimateType_13.set('fieldLabels', {'Mean annua': 'no label', 'Mean ann_1': 'no label', 'Climate Ty': 'no label', 'Modern lat': 'no label', 'Modern lon': 'no label', 'Paleolatit': 'no label', 'Paleolongi': 'no label', 'Precipit_3': 'no label', 'Geochronol': 'no label', 'Notes': 'no label', });
